...
//if this is from check in
        ...
        echo "<form method='post' action='' enctype='multipart/form-data' class='checkingrid'>  
            ...
            <span class='checkinbox7'>
                <label class='Labelform'>Room Selected</label><div class='booking' id='room_id'>" .$_SESSION['room_id']."</div></span>
            <span class='checkinbox8'>
                <label class='Labelform'>Phone Number</label><input type='number' class='booking' name='phone'></span>
            <span class='checkinbox9'>
                <label class='Labelform'>E-mail</label><input type='email' class='booking' name='email'></span>
            <span class='checkinbox10'>
            ...
            <span class='checkinbox11'>
                <label class='Labelform'>ID_number</label><input type='text' class='booking' name='ID_number' class='button' ></span>
            <span class='checkinbox12'>
                <label class='Labelform'>File Upload</label><input type='file' class='booking' name='file'></span>
            <span class='checkinbox13'>
