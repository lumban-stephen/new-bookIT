    ...
    <body>
        ...
        <div id="content">
            ...
            while($row = $result0->fetch_assoc()){
                ...
                <button type='submit' name='search_room'  style='background-color: #003399; padding: 5px; ' class='button'>Search Room</button><a href='manager_guests.php' style='width:15%;'class='Greenbutton'>Back to Guests</a></form>
                ";
